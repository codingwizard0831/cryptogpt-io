...
export function ScrollCustomStyle(theme: Theme, sx: SxProps<Theme>) {
  return {

    scrollbarWidth: 'thin',
    scrollbarColor: `transparent transparent`,
    scrollbarTrackColor: `transparent transparent`,
    ":hover": {
      scrollbarColor: `${alpha(theme.palette.divider, 0.2)} transparent`,
      scrollbarTrackColor: `${alpha(theme.palette.divider, 0.2)} transparent`,
    },
    ...sx,
  };
}
