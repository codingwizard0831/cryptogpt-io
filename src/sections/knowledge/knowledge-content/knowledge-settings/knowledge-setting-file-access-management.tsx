...
import { CoolShareButton } from 'src/components/effect-items/cool-share-button';
...
const KnowledgeSettingFileAccessManagement = () => {
...
export default KnowledgeSettingFileAccessManagement;