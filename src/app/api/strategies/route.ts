...
export async function GET(req: NextRequest) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch frequency strategy data' }, { status: 500 })
    }
}
...
export async function POST(req: NextRequest) {
    try {
        ...
        if (!name || !timeFrame) {
            return NextResponse.json({ error: 'Strategy name and time frame are required' }, { status: 400 });
        }
        ...
        if (parameters && strategyData) {
            ...
            if (paramError) {
                console.log('Error inserting freqency strategy parameters:', paramError)
            }
        ...
        return NextResponse.json({ error: "Failed to create frequency strategy" }, { status: 500 })
    }
}
...
export async function PUT(req: NextRequest) {
    try {
        ...
        if (parameters) {
            ...
            if (paramError) {
                console.log('Error updating frequency strategy parameters:', paramError);
            }
        }
...
export async function DELETE(req: NextResponse) {
    try {
        ...
        return NextResponse.json({ message: "Frequeycy strategy deleted successfully" }, { status: 200 })
    } catch (error) {
        return NextResponse.json({ error: 'Failed to delete frequency strategy' }, { status: 500 })
    }
}